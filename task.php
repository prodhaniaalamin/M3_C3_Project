...
<head>
    ...
    <style>
        ...
        .task {
            color: #888; /* Default task color */
        }
        .task-done {
            text-decoration: line-through;
            color: #888; /* Completed task color-----I wanted to give toggle complete color so I gave it. But here is the same value of default color*/
        }
        .task-item {
            display: flex;
            align-items: center;
    ...
    <div class="container">
        <div class="task-card">
            ...
            <ul style="list-style: none; padding: 0;">
                <?php if (empty($tasks)): ?>
                    <li>No tasks yet. Start adding some!</li>
                <?php else: ?>
